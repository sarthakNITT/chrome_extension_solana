  ...
  return (
    <div className="Header_Home_Box">
      ...
      <span className="Header_Home_Box_Navigator_Btn_Box">
        <a href="#" className="Header_Home_Box_Home_Btn">Home</a>
      ...
      <span className="Header_Home_Box_Home_Section_Box">
        <a href="#" className="Header_Home_Box_Home_Section_Box_Home_Btn">Account</a>
        <a href="#" className="Header_Home_Box_Home_Section_Box_Profile_Btn"><img src={img} className="Header_Home_Box_Home_Section_Box_Image_Icon"></img></a>
      </span>
    </div>
  );
};
